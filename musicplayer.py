...
class MusicPlayer(object):
    ...
    def __init__(self, root, emotionStr):
        ...
        trackframe = LabelFrame(self.root, text="Song Track", font=(
            "times new roman", 15, "bold"), bg="grey", fg="red", bd=5, relief=GROOVE)
        trackframe.place(x=0, y=0, width=620, height=100)
        # Inserting Song Track Label
        songtrack = Label(trackframe, textvariable=self.track, width=20, font=(
            "times new roman", 24, "bold"), bg="grey", fg="yellow").grid(row=0, column=0, padx=10, pady=5)
        # Inserting Status Label
        trackstatus = Label(trackframe, textvariable=self.status, font=(
            "times new roman", 18, "bold"), bg="grey", fg="gold").grid(row=0, column=1, padx=5, pady=5)
        ...
        playbtn = Button(buttonframe, text="SHUFFLE", command=self.shufflesong, width=10, height=1, font=(
        ...
        playbtn = Button(buttonframe, text="NEXT", command=self.nextsong, width=6, height=1, font=(
        ...
        self.playlist = Listbox(songsframe, yscrollcommand=scrol_y.set, selectbackground="green", selectmode=SINGLE, font=(
            "times new roman", 12, "bold"), bg="silver", fg="cyan", bd=5, relief=GROOVE)
